...
async def play(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        await res.edit_text(f"AVENGERS MUSIC BOT=#️⃣ Queued at position {position}.")
    else:
        ...
        caption=f"Playing Your song Via  [AVENGERS MUSIC BOT](https://t.me/avengers_help).",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="final.png",
        caption=f"Playing [{title}]({url}) Via [Deezer](https://t.me/avengers_help)."
    ) 
    os.remove("final.png")
# -----------------------------------------------------Jiosaavn-----------------------------------------------------------------
@Client.on_message(
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [YouTube](https://t.me/avengers_help)",
        photo="final.png",
